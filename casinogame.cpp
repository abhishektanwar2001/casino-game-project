...
// Get player's betting balance
        do
        {
            ...
            cin >> Amount;
            if(Amount > balance)
                cout << "Balance to be bet can not be more than your current balance!\n"
                       <<"\nRe-enter balance\n ";
...
// Get player's numbers
        ...
        if(number == reckon)
        {
            cout << "\n\nCongratulations!! You have won\t " <<char(156) << Amount * 10;
            balance = balance + Amount * 10;
        }
        else
        {
            cout << "Sorry, better luck next time !! You lost" <<char(156) << Amount <<"\n";
            balance = balance - Amount;
        }
        cout << "\nThe lucky number was : " << number <<"\n";
        cout << "\n"<<Name<<", You have a balance of\t " << char(156) << balance <<"\t left "<< "\n";
        if(balance == 0)
        {
    ...
    cout << "\n\n\n";
    cout << "\n\nThanks for playing with us. Your balance is\t " <<char(156)  << balance << "\t now "<< "\n\n";
    return 0;
}
void instructions()
{
